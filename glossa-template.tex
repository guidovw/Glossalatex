...
For languages with non-Roman writing systems, a standard form of romanisation should be used in lieu of the original writing system. State which standard has been used, referring to relevant sources. For articles on Mandarin Chinese, the \emph{Pinyin} transliteration should include tone marks.
...
\item for words and expressions from classical languages (\emph{ad hoc}, \emph{de se}, \emph{hoi polloi}, etc.) 
