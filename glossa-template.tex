...
For languages with non-Roman writing systems, a standard form of romanisation should be used. State which standard has been used, referring to relevant sources. For articles on Mandarin Chinese, the \emph{Pinyin} transliteration should include tone marks.
